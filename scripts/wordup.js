 ...
 *
 * Subsequently updates the .isRealWord prperty of
...
function checkIfWordIsReal(word) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            model.wordSubmissions.forEach(function(submission, index) {
               if(submission.word == word){
                //    submission.word.isRealWord = theAnswer;
...
function render() {
    ...
    var submittedWords = model.wordSubmissions.map(wordSubmissionChip);
...
function wordSubmissionChip(wordSubmission) {
    ...
    if (wordSubmission.hasOwnProperty("isRealWord")) {
        ...
        if (wordSubmission.isRealWord == true){
                ...
                var scoreChip = $("<span></span>").text(score).addClass("tag tag-sm tag-primary");
            }
        else {
            var scoreChip = $("<span></span>").text("X").addClass("tag tag-sm tag-danger");
        }
